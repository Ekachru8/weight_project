      ...
      if (result?.error) {
        setError(
          mode === "login"
            ...
            : "Account created but auto-login failed. Try logging in."
        );
      } else {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12 relative">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        {/* Auth Card */}
        <div className="glass-card p-6 sm:p-8 fade-in-up opacity-0" style={{ animationDelay: "100ms" }}>
          {/* Google Sign In */}
          <button
            id="google-signin-btn"
            onClick={handleGoogleSignIn}
            disabled={googleLoading}
            className="w-full flex items-center justify-center gap-3 px-4 py-3.5 rounded-xl bg-white/5 border border-border hover:bg-white/10 text-foreground font-semibold transition-all duration-300 mb-6"
          >
            {googleLoading ? (
          ...
          <form onSubmit={handleCredentialsSubmit} className="space-y-4">
            ...
            <button
              ...
              type="submit"
              disabled={loading}
              className="w-full py-3.5 rounded-xl text-base font-bold accent-gradient text-black hover:opacity-90 shadow-lg shadow-accent/20 transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-60"
            >
              {loading ? (
                <Loader2 size={20} className="animate-spin" />
              ) : mode === "login" ? (
